...
async function run() {
  try {
    ...
    <p>Your order is now being processed, and you will receive a notification once it has been shipped. You can track your order status using the following link: <a href="https://tasty-twist-food.netlify.app/${
      req?.body?.tackingUrl
    }">Track Order</a>.</p>
    ...
    <a href="https://tasty-twist-food.netlify.app">Tasty Twist</a></p>
        </div>`,
      });
    });
